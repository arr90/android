package com.example.and_notas.util;
...
/**
 * Created by arr90 on 10/08/2017.
 */
public class MyLocation {
    private static final String LOG_MY_LOCATION = MyLocation.class.getSimpleName();
    ...
    {
        Log.i(LOG_MY_LOCATION, "LOG ["+Thread.currentThread().getStackTrace()[2].getMethodName()+"] {**********}");
